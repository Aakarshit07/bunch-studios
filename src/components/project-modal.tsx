...
//   return (
//     <div className="fixed inset-0 z-50 flex justify-end border-2">
//       {/* Backdrop */}
...
//       <SheetContent
//         side="right"
//         className="w-full sm:max-w-[1000px] overflow-y-auto"
//       >
//         <SheetHeader className="relative border-b">
//           <SheetClose className="absolute top-4 right-4" />

//           <SheetTitle className="text-3xl font-bold text-gray-950 underline">
//             <Link href={"#"} target="_blank">{selectedProject.title}</Link>
//           </SheetTitle>
...
//             <>
//               {/* Image Carousel */}
//               <div className="bg-gradient-to-br from-blue-300 to-blue-400 p-6 relative rounded-xl">
//                 <div className="flex justify-center items-center space-x-4 min-h-[400px]">
//                   {selectedProject.images.slice(0, 5).map((image, index) => (
//                     <div
//                       key={index}
...
//               {/* Description */}
//               <div className="bg-white p-4 space-y-6 flex flex-col gap-8">
...
// Updated ProjectModal component with ShadCN Carousel for responsiveness
