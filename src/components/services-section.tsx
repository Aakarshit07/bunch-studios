        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start mb-12">
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <p className="text-secondary-400 text-sm uppercase tracking-wide font-medium">Our Services</p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {services.map((service, index) => (
            ...
            >
              <div className="space-y-6">
                <div className="space-y-4">
                  <div className="bg-primary/10 rounded-xl flex items-center justify-center w-[100px] h-[100px] p-2 bg-white shadow-md">
                    <Image src={service.icon} alt={service.title} width={60} height={60} />
                  </div>
                  <h3 className="text-2xl font-medium text-gray-950">{service.title}</h3>
                </div>

                <ul className="space-y-2 list-disc pl-5">
                  {service.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className=" text-primary-900 font-normal text-base">
                      {feature}
                    </li>
                  ))}
                </ul>
